...
<form method="POST" action="{{ route('roles.store') }}" class="shadow-sm p-4 rounded" style="background-color: #f8f9fa;">
    @csrf
    <div class="mb-3">
...
<p class="text-center text-muted mt-4"><small>By Maritza 💜</small></p>
@endsection
